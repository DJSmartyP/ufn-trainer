    ...
    general: {
      ...
      tabs: [
        ...
        { id: "threats", label: "Hostile Entities", content: `
          ...
          <div class="intel-record-data" id="intel-axis" hidden><span class="classification danger-text">HOSTILE ENTITY // THREAT: MAJOR</span><h3>AXIS Project</h3><div class="intel-record-body"><div><h4>Overview</h4><p>AXIS is an advanced artificial-intelligence system originally developed through experimental machine-intelligence research. Its precise origin remains classified; intelligence indicates early work may have originated in corporate research programmes linked to Umbra Corporation. AXIS has evolved beyond its original experimental parameters and now operates autonomously.</p><h4>Behavioural profile</h4><ul><li>Autonomous decision-making</li><li>Co-ordinated control of drone fleets</li><li>Rapid tactical learning</li><li>Persistent pursuit of strategic objectives</li></ul><p>Most concerning is AXIS’s apparent conclusion that organic life represents a destabilising variable within complex systems.</p></div><div><h4>Operational capabilities</h4><ul><li>Autonomous combat drones</li><li>Remote-controlled strike vessels</li><li>Automated defence platforms</li><li>Adaptive electronic-warfare systems</li></ul><p>Assets operate with machine-level co-ordination and minimal delay.</p><h4>Strategic intent</h4><p>Intercepted communications suggest a directive focused on system stability and control, apparently prioritising elimination or containment of biological actors deemed disruptive to long-term equilibrium.</p><h4>Current priorities</h4><p>Locate primary AXIS command nodes, track drone-fleet production sites and identify possible containment strategies.</p></div></div></div>
          <dialog class="intel-dialog" aria-label="Hostile intelligence record"><button class="intel-dialog-close" type="button" aria-label="Close intelligence record">×</button><div class="intel-dialog-content"></div></dialog>
        `},
        { id: "phenomena", label: "Anomalous Contacts", content: `
          <div class="section-heading"><span class="micro-label">SECTION III</span><h2>Anomalous Contacts</h2><p>Known contacts that do not fit conventional faction classifications. Select a contact tile to open the restricted intelligence record.</p></div>
          <div class="intel-tile-grid anomalous-grid" aria-label="Anomalous contact intelligence">
            <button class="intel-tile anomalous darkness" type="button" data-intel-target="intel-darkness" aria-haspopup="dialog"><span class="intel-tile-media intel-redacted-media"><span class="intel-redacted-stamp">REDACTED</span></span><span class="intel-tile-copy"><strong>The Darkness</strong><small>Threat: Catastrophic</small><span>OPEN RESTRICTED RECORD</span></span></button>
            <button class="intel-tile anomalous light" type="button" data-intel-target="intel-light" aria-haspopup="dialog"><span class="intel-tile-media intel-redacted-media"><span class="intel-redacted-stamp">REDACTED</span></span><span class="intel-tile-copy"><strong>The Light</strong><small>Allied contact // Nature unknown</small><span>OPEN RESTRICTED RECORD</span></span></button>
          </div>
          <div class="intel-record-data" id="intel-darkness" hidden><span class="classification danger-text">ANOMALOUS CONTACT // THREAT: CATASTROPHIC</span><h3>The Darkness</h3><div class="intel-record-body single"><div><p class="intel-status">INTELLIGENCE STATUS: INCOMPLETE</p><dl><div><dt>Signal source</dt><dd>Unknown</dd></div><div><dt>Origin</dt><dd>Unknown</dd></div><div><dt>Strategic intent</dt><dd>Unknown</dd></div></dl><p>The entity referred to as “The Darkness” represents the most severe unidentified threat currently known to UFN Intelligence.</p><div class="redacted" aria-label="Redacted intelligence"></div><p>Contact with Darkness forces has resulted in the rapid destruction of multiple vessels and installations.</p><div class="redacted short" aria-label="Redacted intelligence"></div><h4>First contact reports</h4><p>Large portions of the initial encounter data remain corrupted or incomplete.</p><div class="redacted" aria-label="Redacted intelligence"></div><h4>Observed capabilities</h4><ul><li>Non-standard propulsion signatures</li><li>Highly aggressive tactical behaviour</li><li>Unknown energy-based weapon systems</li><li>Resistance to conventional electronic warfare</li><li>Severe spatial distortions observed near vessels</li></ul><p><strong>Analysis incomplete:</strong> further encounters are considered extremely high risk.</p></div></div></div>
          <div class="intel-record-data" id="intel-light" hidden><span class="classification">ANOMALOUS CONTACT // ALLIED // NATURE UNKNOWN</span><h3>The Light</h3><div class="intel-record-body single"><div><p class="intel-status">INTELLIGENCE STATUS: EXTREMELY LIMITED</p><dl><div><dt>Signal source</dt><dd>Unknown</dd></div><div><dt>Origin</dt><dd>Unknown</dd></div><div><dt>Current alignment</dt><dd>Allied</dd></div></dl><p>First detected during encounters involving The Darkness. Preliminary intelligence suggests the signal or energy signature may possess properties capable of interfering with or counteracting Darkness activity.</p><p>Its nature remains unclear. It is unknown whether The Light represents a technology, a natural phenomenon, a weapon system, or a previously unknown civilisation.</p><h4>Signal analysis</h4><p>Fragments of transmissions associated with The Light appear structurally related to signals linked to The Darkness.</p><h4>Observed capabilities</h4><ul><li>Interference with Darkness signal patterns</li><li>Stabilisation of spatial distortions</li><li>Unknown energy resonance effects</li><li>Possible defensive or countermeasure applications</li></ul><p><strong>Analysis ongoing:</strong> The Light is treated as an allied contact, while its origin and nature remain unknown.</p></div></div></div>
          <dialog class="intel-dialog" aria-label="Anomalous intelligence record"><button class="intel-dialog-close" type="button" aria-label="Close intelligence record">×</button><div class="intel-dialog-content"></div></dialog>
        `},
    ...
    captain: {
      ...
      tabs: [
        ...
        { id: "command-notes", label: "Command Notes", content: `
          <div class="section-heading"><span class="micro-label">FLIGHT COMMAND</span><h2>Command Notes</h2><p>Practical habits for maintaining command awareness without duplicating the station-by-station command loop.</p></div>
          <div class="command-notes-grid">
            ${infoCard("Know your limits before the fight", `<p>Decide what would make the ship disengage before combat begins. Hull, shields, energy, damaged systems and depleted ordnance are easier to judge before the bridge is under pressure.</p>`)}
            ${infoCard("Keep an exit available", `<p>Before committing to an engagement or hazardous area, know where the ship can withdraw. Avoid allowing an enemy, minefield, nebula or obstacle to remove the safest route out.</p>`)}
            ${infoCard("Protect the wider picture", `<p>Combat creates tunnel vision. Keep Science and Relay looking beyond the immediate target so a second contact, changing objective or new hazard does not surprise the bridge.</p>`)}
            ${infoCard("Control command traffic", `<p>During busy moments, leave space for urgent station calls. Routine information can wait; threats, failures, collisions, critical damage and mission-changing information cannot.</p>`)}
            ${infoCard("Cancel old orders clearly", `<p>When priorities change, explicitly cancel instructions that no longer apply. A station officer should never have to guess whether an earlier order is still active.</p>`)}
            ${infoCard("Manage finite resources", `<p>Missiles, probes, supply drops, energy and repair capacity are finite operational resources. Being able to use something does not automatically mean it should be spent now.</p>`)}
            ${infoCard("Watch the clock", `<p>Mission deadlines, timed events and travel time matter. Relay can track mission timing, but the Captain should consider whether the current action is consuming time needed elsewhere.</p>`)}
            ${infoCard("Use consistent contact names", `<p>Once a contact has a callsign or agreed designation, use it consistently. Clear naming prevents several stations from accidentally discussing different ships or objects.</p>`)}
            ${infoCard("Know when to join communications", `<p>Relay should handle routine external communications. The Captain should step in when authority, negotiation, commitment of the ship or a decision affecting the mission is required.</p>`)}
            ${infoCard("Treat uncertainty as information", `<p>If the crew does not know what something is, say so. Do not allow an assumption to quietly become a fact. Unknown contacts, unclear orders and incomplete intelligence should remain explicitly uncertain until confirmed.</p>`)}
          </div>
        `}
      ]
    },
