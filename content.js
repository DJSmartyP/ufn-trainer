(() => {
  ...
  const rankCard = (name, image, note = "") => `
    <article class="rank-card">
      ...
      <div class="rank-card-copy">
        ...
        <h3>${name}</h3>
        ${note ? `<p class="rank-approval">${note}</p>` : ""}
      </div>
    </article>`;
      ...
      tabs: [
        ...
        { id: "ranks", label: "Ranks", content: `
          ...
          <div class="promotion-regulation">
            ...
            <div>
              <h3>Senior promotions require formal approval</h3>
          ...
          <div class="rank-grid">
            ${rankCard("Ensign", "ensign.png")}
            ${rankCard("Sub Lieutenant", "sub-lieutenant.png")}
            ${rankCard("Lieutenant", "lieutenant.png")}
            ${rankCard("Lieutenant Commander", "lieutenant-commander.png", "Admiral sign-off required for promotion to this rank.")}
            ${rankCard("Commander", "commander.png", "Admiral sign-off required for promotion to this rank.")}
            ${rankCard("Captain", "captain.png", "Admiralty sign-off and full review by the Admirals required.")}
            ${rankCard("Commodore", "commodore.png", "Admiralty sign-off and full review by the Admirals required.")}
            ${rankCard("Rear Admiral", "rear-admiral.png", "Admiralty sign-off and full review by the Admirals required.")}
            ${rankCard("Vice Admiral", "vice-admiral.png", "Admiralty sign-off and full review by the Admirals required.")}
            ${rankCard("Admiral", "admiral.png", "Admiralty sign-off and full review by the Admirals required.")}
          </div>
        `},
